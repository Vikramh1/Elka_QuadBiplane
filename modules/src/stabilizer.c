...
static void stabilizerTask(void* param)
{
	...
	while (1)
	{
       ...
       for(i=0;i<1000;i++)
       {
		...
		else if(counter!=spektrumchannel[6])
		{
			kay=0;
		}
		counter=spektrumchannel[6];*/
	    ...
	    euler.data[4] = (int)(spektrumchanneltemp[0]);
		euler.data[5] = (int)(actuatorThrust);
		euler.data[6] = (int)(spektrumchannel[5]);
